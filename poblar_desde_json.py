...
# Búsqueda exacta e inscripción en la ontología
...
with onto:
    for i_data in data.get("incidentes", []):
        tipo_str = i_data.get("tipo_incidente", "Fallo")
        
        if tipo_str == "Ataque":       clase_inc = Ataque
        elif tipo_str == "Sabotaje":   clase_inc = Sabotaje
        elif tipo_str == "Fallo":      clase_inc = Fallo
        else:                          clase_inc = Interferencia
